...
public class DataWriter
{
    ...
    {
        AdvancedSystemManager2.packetHandler.sendToAllAround(createPacket(), new TargetPoint(dimension, x, y, z, r));
    }

    void sendPlayerPacket(EntityPlayerMP player)
    {
        AdvancedSystemManager2.packetHandler.sendTo(createPacket(), player);
    }

    void sendServerPacket()
    {
        AdvancedSystemManager2.packetHandler.sendToServer(createPacket());
    }
